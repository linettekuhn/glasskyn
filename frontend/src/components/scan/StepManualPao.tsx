...
export default function StepManualPao() {
  const { setPaoMonths, setStep } = useScanContext();
    ...
    <SafeAreaView style={styles.container} edges={["bottom"]}>
      <KeyboardAvoidingView style={styles.inner} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>How many months after opening is this product good for?</Text>
          ...
          <Text style={styles.hint}>Examples: 12M, 6, 24 months, 12 mois</Text>
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: "#ddd", borderRadius: 12, padding: 16, fontSize: 20, backgroundColor: "#fafafa", color: "#1a1a1a", textAlign: "center", marginBottom: 8 },
  hint: { fontSize: 13, color: "#999", textAlign: "center", marginBottom: 32 },
  submitButton: { backgroundColor: "#6c63ff", borderRadius: 12, padding: 16, alignItems: "center" },
